...
const loginReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case SET_PASSWORD_TOGGEL: {
      return {
        ...state,
        passwordToggle: action.newValue
      }
    }
  }
}

export const setIsLoggedIn = (isLogedIn, validEmail) => {
  return {
    type: CHACK_IS_LOGGED_IN,
    isLogedIn,
    validEmail
  }
}
...
export const setPasswordToggle = (newValue) => {
  return {
    type: SET_PASSWORD_TOGGEL,
    newValue
  }
}
